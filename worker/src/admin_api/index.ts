...
api.post('/admin/test/cloudflare_api/zones/:zoneId/email/routing/dns', e2e_test_api.mockCloudflareEmailRoutingProvisionDns);
api.patch('/admin/test/cloudflare_api/zones/:zoneId/email/routing/dns', e2e_test_api.mockCloudflareEmailRoutingUnlockDns);
api.post('/admin/test/cloudflare_api/zones/:zoneId/email/routing/disable', e2e_test_api.mockCloudflareEmailRoutingDisable);
api.get('/admin/test/cloudflare_api/zones/:zoneId/dns_records', e2e_test_api.mockCloudflareDnsRecordList);
api.delete('/admin/test/cloudflare_api/zones/:zoneId/dns_records/:recordId', e2e_test_api.mockCloudflareDnsRecordDelete);
